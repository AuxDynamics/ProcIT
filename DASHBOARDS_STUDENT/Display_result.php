				...
				<div class="" style="width: 100%;">
					<div class="border">
						...
						<?php
							...
							?>					
						<div id="mcq_type">
							<div class="question bg-white p-3 border-bottom" style="height: 450px; margin-top:10px;width:105%;">
						...
						<div id="one_word_type">
							<div class="question bg-white p-3 border-bottom" style="height: 340px; margin-top:10px;width:105%;">
								<div class="d-flex flex-row align-items-center question-title"style="padding: 10px;	">
									<h3 class="">Q.</h3>
									<h5 class="mt-1 ml-2"><?php echo $question[$q_i]; ?><p class="anss<?php if($flag_array[$q_i-1]=="0"){echo "i";} ?>"> <?php if($flag_array[$q_i-1]=="0"){echo "<b>Incorrect</b>";}else{echo "<b>Correct</b>";} ?> </p>
									</h5>
						...
						<div id="true_false_type">
							<div class="question bg-white p-3 border-bottom" style="height: 320px; margin-top:10px;width:105%;">
								<div class="d-flex flex-row align-items-center question-title"style="padding: 10px;	">
									<h3 class="">Q.</h3>
									<h5 class="mt-1 ml-2"><?php echo $question[$q_i]; ?><p class="anss<?php if($flag_array[$q_i-1]=="0"){echo "i";} ?>"> <?php if($flag_array[$q_i-1]=="0"){echo "<b>Incorrect</b>";}else{echo "<b>Correct</b>";} ?> </p>
									</h5>
